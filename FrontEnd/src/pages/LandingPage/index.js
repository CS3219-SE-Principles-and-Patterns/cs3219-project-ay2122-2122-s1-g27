    ...
    <Grid container justifyContent='center'>
      ...
      <Grid item xs={12}>
        <Typography
          ...
          variant='h4'
          component='div'
          sx={{ fontWeight: 600, color: '#FFE448', paddingBottom: '50px' }}
        >
          Hello confidence.
        </Typography>
      </Grid>
      <Grid item xs={10}>
        ...
        >
          Join us now if you want to practice for coding interviews together with friends, experts
          or noobs. We have them all.
        </Typography>
      </Grid>

      <Grid item xs={12}>
        <Typography align='center' variant='h6' component='div' sx={{ color: '#FDFDFD' }}>
